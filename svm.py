...
def extract_features(wavs, imgs):
    X = []
...
# -----------------------------------------------------------
print("训练 SVM 回归器...")
reg = SVR(kernel="rbf", C=8, epsilon=0.2, gamma='auto')  # 参数可自行调整
...
# 6. 模型保存与推理计时
# -----------------------------------------------------------
joblib.dump(reg, "xigua_svm_best.joblib")
print("已保存模型到 xigua_svm_best.joblib")
